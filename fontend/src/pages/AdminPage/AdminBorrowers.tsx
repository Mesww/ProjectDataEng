...
import Borrower from "../../interfaces/BorrowersInterface"; // Assume this interface is defined with the fields in the response data
...
const AdminBorrowers = () => {
  ...
  const handleAddBorrower = async () => {
    try {
      const response = await addborrower(newBorrower);
      setBorrowers((prev) => [...prev, response]);
      setShowAddModal(false);
      setNewBorrower({ name: "", email: "", phone: "", activeStatus: true, role: "user", borrowing_history: [] });
    } catch (err) {
